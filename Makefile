...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=ipi \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=ipid \
		  -X github.com/cosmos/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/cosmos/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X github.com/CosmWasm/wasmd/app.Bech32Prefix=ipi \
...
ifeq ($(OS),Windows_NT)
	...
	go build -mod=readonly $(BUILD_FLAGS) -o build/ipid ./cmd/ipid
endif

build-windows-client: go.sum
	GOOS=windows GOARCH=amd64 go build -mod=readonly $(BUILD_FLAGS) -o build/ipid.exe ./cmd/ipid

install: go.sum
	go install -mod=readonly $(BUILD_FLAGS) ./cmd/ipid
...
draw-deps:
	...
	@goviz -i ./cmd/ipid -d 2 | dot -Tpng -o dependency-graph.png
