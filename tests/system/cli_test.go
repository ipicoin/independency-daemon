...
func TestParseMsgExecuteContractResponse(t *testing.T) {
	data, err := hex.DecodeString("")
	require.NoError(t, err)
	contractResponse, err := ParseMsgExecuteContractResponse(data)
	require.NoError(t, err)
	assert.JSONEq(t, `{"block":{"height":15,"time":"1748947405184178000","chain_id":"testing"},"transaction":{"index":0,"hash":""},"contract":{"address":"ipi14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9sccv9tz"}}`, string(contractResponse))
}
